...
{
    public partial class ThiLai : Form
    {
        public ThiLai()
        {
            InitializeComponent();
        ...
        {
            string sql = "select * from KETQUA1 where DiemChu = N'D'  ";
        ...
        private void ThiLai_Load(object sender, EventArgs e)
        {
            moketnoi();
            hienthi();
        ...
        {
            string sql = "select * from KETQUA1 where MaSV = '" + txtMaSV.Text + "' and DiemChu = N'D'  ";
            DataTable dtKQ = new DataTable();
            DataSet ds = new DataSet();
            SqlCommand cmd = new SqlCommand(sql, conn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        private void ThiLai_FormClosing(object sender, FormClosingEventArgs e)
        {
